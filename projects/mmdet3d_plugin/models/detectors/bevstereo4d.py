...
class BEVStereo4D(BEVDepth4D):
    ...
    def prepare_bev_feat(self, img, sensor2keyego, ego2global, intrin,
        ...
        bev_feat, depth = self.img_view_transformer(
            [x, sensor2keyego, ego2global, intrin, post_rot, post_tran, bda,
             mlp_input], metas)
        # bev_feat, depth, depth_supervision = self.img_view_transformer(
        #     [x, sensor2keyego, ego2global, intrin, post_rot, post_tran, bda,
        #      mlp_input], metas)
    ...
    def extract_img_feat_sequential(self, inputs, feat_prev):
        ...
        bev_feat, depth, _, depth_supervision = self.prepare_bev_feat(*inputs_curr)
        ...
        return [x], depth, depth_supervision
    ...
    def extract_img_feat(self,
        ...
        """
        # print("*************** extract_img_feat in BEVStereo4D *************")
        ...
        for fid in range(self.num_frame-1, -1, -1):
            ...
            if key_frame or self.with_prev:
                ...
                if key_frame:
                    ...
                    # bev_feat, depth, feat_curr_iv, depth_supervision = \
                    #     self.prepare_bev_feat(*inputs_curr)
    ...
    #             bda_rot:  (B, 3, 3)
    #     """
    #     print("*******  extract_feat in BEVStereo4D *******")
    #
    #     img_feats, depth = self.extract_img_feat(img_inputs, img_metas, **kwargs)
    #     # img_feats, depth, depth_supervision = self.extract_img_feat(img_inputs, img_metas, **kwargs)
    #     pts_feats = None
